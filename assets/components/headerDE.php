        ...
        <header>
            ...
            <nav id="desktop_nav">
                <ul id="desktop_nav_main">
                    <li><a href="https://projects.areimann.de/archive/portfolio-v1/lang/de">Startseite</a></li>
                    <li><a href="https://projects.areimann.de/archive/portfolio-v1/lang/de/pages/cv.php">Lebenslauf</a></li>
                    ...
                    <li><a href="https://projects.areimann.de/archive/portfolio-v1/lang/de/pages/links.php">Linksammlung</a></li>
                </ul>
            </nav>
            <nav id="mobile_nav">
            ...
            <img id="lang" src="https://projects.areimann.de/archive/portfolio-v1/assets/img/flags/de.png">
        </header>
